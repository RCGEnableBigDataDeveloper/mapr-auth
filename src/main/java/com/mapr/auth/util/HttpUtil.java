...
public class HttpUtil {
	...
	public static void main(String[] args) {
		String res = post("http://127.0.0.1:8080/sample/hello/hive/uuu","{ \"name\" : \"local-filesystem\", \"host\" : \"maprdemo.local\", \"path\" : \"/apps\", \"user\" : \"\", \"pwd\" : \"\", \"type\" : \"file\", \"port\" : \"\", \"clazz\" : \"com.rcggs.datalake.connect.fs.HDFSConnection\", \"properties\" : null }");
